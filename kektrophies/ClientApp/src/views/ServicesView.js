              ...
              <div id="services_view">
                ...
                <BodyContainer>
                    <BodyItem paper fill xs={12} sm={6} md={6}>
                        <div>
                            <h2>Medals</h2>
                            <p>We stock thousands of low cost medals and ribbons; which can all be personalised with your logo/design and a coloured ribbon to suit your team or company.</p>
                        </div>
                    </BodyItem>
                    ...
                    <BodyItem paper fill xs={12} sm={6} md={4}>
                        <div>
                            <h2>Sports</h2>
                            <p>We supply trophies for almost any sport or award you can think of. Our extensive range includes football, rugby, boxing, netball, gymnastics, dance and many more.</p>
                        </div>
                    </BodyItem>
